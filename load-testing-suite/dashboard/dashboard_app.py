# dashboard/dashboard_app.py - Based on dashboard_old with selected dashboard features
"""
Enhanced Load Test Dashboard - Based on dashboard_old architecture
"""
...
app = FastAPI(title="Enhanced Load Test Dashboard", version="2.1.0")
